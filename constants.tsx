...
export const PRICING_PLANS: PricingPlan[] = [
  {
    ...
    description:
      "Perfect for businesses looking for a fast, professional, and SEO-friendly WordPress website.",
    features: [
  ...
  {
    id: 2,
    name: "Custom Laravel Website",
    price: "PKR 25,000",
    period: "Starting From",
    description:
      "Perfect for businesses needing custom functionality, dashboards, and scalable web applications.",
    features: [
      "Fully Custom Laravel Development",
      "Admin Dashboard",
  ...
  },
  {
    ...
    period: "Starting From",
    description:
      "Ideal for startups and businesses looking to launch scalable SaaS platforms with subscription-based models.",
    features: [
