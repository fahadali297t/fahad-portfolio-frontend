        ...
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {project.gallery.map((img, i) => (
              <div
                key={i}
                className="rounded-[2.5rem] overflow-hidden aspect-video border border-white/10 group"
              >
                <img
                  src={"/" + img}
      ...
      <section className="relative h-[60vh] flex flex-col items-center justify-center text-center px-6 border-t border-white/10 overflow-hidden group">
        <div className="absolute inset-0 z-0">
          <img
            ...
            className="w-full h-full object-cover opacity-10 grayscale group-hover:opacity-20 group-hover:scale-110 transition-all duration-1000"
          />
