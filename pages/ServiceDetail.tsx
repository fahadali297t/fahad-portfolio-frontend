    ...
    <div ref={containerRef} className="bg-black text-white overflow-x-hidden">
      ...
      <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          <span className="hero-title-part text-[#004aad] font-poppins text-xs uppercase tracking-[0.6em] block mb-8 font-bold">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-4 reveal-on-scroll">
            <div className="p-10 bg-white/5 border border-white/10 rounded-[3rem] space-y-8">
              <h4 className="text-sm font-poppins text-[#004aad] uppercase tracking-widest font-bold">
                Key Focus Areas
              </h4>
                ...
                {service.capabilities.map((cap, i) => (
                  <li key={i} className="flex gap-4 group">
                    <div className="mt-1">
                      <ChevronRight
                        size={16}
                        className="text-[#004aad] group-hover:translate-x-1 transition-transform"
                      />
                    </div>
      ...
      <section className="relative py-40 px-6 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center space-y-16">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-8">
            <Link
              to="/contact"
              className="group flex items-center gap-6 px-12 py-6 bg-[#004aad] text-white rounded-full font-white text-xl hover:scale-105 transition-all shadow-[0_0_50px_rgba(0,74,173,0.2)]"
            >
