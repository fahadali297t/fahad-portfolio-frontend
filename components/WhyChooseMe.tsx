...
const WhyChooseMe: React.FC = () => {
  ...
  return (
    <section ref={containerRef} className="py-32 bg-black text-white relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1000px] h-[1000px] bg-[#004aad]/5 blur-[150px] rounded-full pointer-events-none"></div>
        ...
        <div className="advantage-grid grid grid-cols-1 md:grid-cols-2 gap-6">
          {ADVANTAGES.map((adv, i) => (
            ...
            >
              ...
              <div className="absolute bottom-0 right-0 w-24 h-24 bg-gradient-to-br from-transparent to-[#004aad]/5 opacity-0 group-hover:opacity-100 transition-opacity"></div>
            </div>
          ))}
        </div>
